...
<head>
    ...
    <!-- Bootstrap CSS
        ...
        <!-- nalika Icon CSS
            ============================================ -->
        <link rel="stylesheet" href="{{ asset('admin_assets/css/nalika-icon.css') }}">
        <!-- owl.carousel CSS
            ============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="/admin_assets/img/logo/logo.png" alt="" /></a>
                <strong><img src="/admin_assets/img/logo/logosn.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="/admin_assets/img/notification/4.jpg" alt="" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="{{ route('category.index') }}" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Categories</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Index" href="{{ route('category.index') }}"><span class="mini-sub-pro">Index</span></a></li>
                                <li><a title="Create" href="{{ route('category.create') }}"><span class="mini-sub-pro">Create</span></a></li>
                            </ul>
                        </li>
                        <li>
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin_assets/img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin_assets/img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin_assets/img/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin_assets/img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
    ...
    <!-- meanmenu JS
		============================================ -->
    <script src="{{ asset('admin_assets/js/jquery.meanmenu.js') }}"></script>
    <!-- owl.carousel JS
		============================================ -->
    ...
    <script src="{{ asset('admin_assets/js/scrollbar/mCustomScrollbar-active.js') }}"></script>
    <!-- metisMenu JS
		============================================ -->
    ...
    <script src="{{ asset('admin_assets/js/flot/jquery.flot.orderBars.js') }}"></script>
    <script src="{{ asset('admin_assets/js/flot/curvedLines.js') }}"></script>
    <script src="{{ asset('admin_assets/js/flot/flot-active.js') }}"></script>
    <!-- plugins JS
		============================================ -->
